            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block  "  style="background:10px 10px url(<?php echo base_url();?>/images/f1.svg);">
							<h4 style="color:#dddddd;font-weight:900;margin-top:50px;margin-left:50px;"><?php echo $this->config->item('app_name');?></h4>
							<h2 style="color:#dddddd;font-weight:700;margin-top:20px;margin-left:50px;">
							One step away to create managed cloud server
							</h2>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="<?php echo site_url('login/insertUser');?>">
                                    ...
                                    <div class="text-center">
                                     ...
                                     |
                                        <a class="small" href="<?php echo site_url('login');?>">Login</a><br>
                                        <a class="small" href="<?php echo base_url();?>"><?php echo $this->config->item('app_name');?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
