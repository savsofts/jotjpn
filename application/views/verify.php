                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Verify Email ID</h1>
                                    </div>
                                    <form class="user" method="post" action="<?php echo site_url('login/verifyCode');?>">
									<?php if($this->session->flashdata('message')){ echo $this->session->flashData('message'); }?>
                                        <div class="form-group">
										<label>Enter 6 digit code sent in email</label>
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp" name="code"
                                                placeholder="Enter 6 digit code sent in email" required >
                                        </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo site_url('login/resend');?>">Resend code</a> | 
                                        <a class="small" href="<?php echo site_url('login/logout');?>">Logout</a>
                                    </div>
                                </div>
                            </div>
                        </div>
