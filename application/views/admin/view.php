...
<div class="card">
  <div class="card-header">
    <b style="font-size:16px;"><?php echo $result['title'];?></b><a href="<?php echo site_url('admin/support');?>" class="btn btn-primary btn-sm" style="float:right;">Back</a><br>
...
<div class="card-body">
<form method="post" action="<?php echo site_url('admin/update_ticket/'.$id);?>" enctype="multipart/form-data">
...
<option value="Open" <?php if($result['ticket_status']=="Open"){ echo 'selected';}?>>Open</option>
<option value="Closed" <?php if($result['ticket_status']=="Closed"){ echo 'selected';}?>>Close</option>
</select>
</div>
