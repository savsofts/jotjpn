...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Select Server <a href="javascript:location.reload();"><i class='fa fa-sync-alt'></i></a></h1>
        <!--
							...
							<div class="col-lg-4 mb-4">
									...
									<div class="card" style="">
									  <div class="card-body">
										...
										<h5 class="card-title"><a href="<?php echo site_url('support/create_ticket/'.$server['client_id'].'/'.$server['server_id']);?>"><?php echo $server['server_name'];?></a></h5>
